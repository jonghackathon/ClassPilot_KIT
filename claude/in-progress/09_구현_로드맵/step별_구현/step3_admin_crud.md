...
| 3 | `src/app/api/classes/[id]/enroll/route.ts` | POST (등록), DELETE (해제) |
...
| # | 파일 | 작업 |
|---|------|------|
| 1 | `src/app/api/schedules/route.ts` | GET, POST |
| 2 | `src/app/api/schedules/[id]/route.ts` | PATCH, DELETE |
...
| # | 파일 | 작업 |
|---|------|------|
| 1 | `src/app/api/ai/complaint/route.ts` | GET, POST |
| 2 | `src/app/api/ai/complaint/[id]/route.ts` | PATCH — 응답 처리 |
